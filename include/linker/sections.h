...
#define _ACT_S3_NOT_SAVE_SECTION_NAME	.act_s3_not_save_mem
#define _ACTS_RAM3_SESSION_NAME .act_ram3_mem
#define _ACTS_NETBUF_DATA_SESSION_NAME .act_netbuf_data
#define _ACTS_ENC_BUF_SESSION_NAME .act_enc_buf
#define _ACTS_PCM_BUF_SESSION_NAME .act_pcm_buf
#define _ACTS_OTA_BUF_SESSION_NAME .act_ota_buf
#define _ACTS_SLEEP_BSS_SESSION_NAME .act_sleep_bss
#define _ACTS_STK_SESSION_NAME act_stack
