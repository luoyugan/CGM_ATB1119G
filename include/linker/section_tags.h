...
#define __act_s3_notsave	Z_GENERIC_SECTION(_ACT_S3_NOT_SAVE_SECTION_NAME)
#define __acts_ram3_session Z_GENERIC_SECTION(_ACTS_RAM3_SESSION_NAME)
#define __acts_netbuf_data		Z_GENERIC_SECTION(_ACTS_NETBUF_DATA_SESSION_NAME)
#define __acts_enc_buf		Z_GENERIC_SECTION(_ACTS_ENC_BUF_SESSION_NAME)
#define __acts_pcm_buf		Z_GENERIC_SECTION(_ACTS_PCM_BUF_SESSION_NAME)
#define __acts_ota_buf		Z_GENERIC_SECTION(_ACTS_OTA_BUF_SESSION_NAME)
#define __acts_sleep_bss		Z_GENERIC_SECTION(_ACTS_SLEEP_BSS_SESSION_NAME)
...
#if defined(CONFIG_ACTS_DEDICATED_MEMORY)
#define __kstackmem __in_section_unique(_ACTS_STK_SESSION_NAME)
#else
