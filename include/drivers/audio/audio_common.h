...
#elif defined(CONFIG_SOC_SERIES_TAI)

#define ADC_CH_NUM_MAX                         (1)

#define ADC_CH_INPUT0P                         (1) /* ADC channel INPUT0 positive point */
#define ADC_CH_INPUT0NP_DIFF                   (2) /* ADC channel full differencial mode */
#define ADC_CH_DMIC                            (3)
