...
static struct device *g_gpio_dev[GPIO_MAX_GRP];
		...
		enum gpio_int_trig trig)
{
	...
	set_mask = GPIO_CTL_INTC_MASK | GPIO_CTL_INTC_EN | GPIO_CTL_INC_TRIGGER_MASK;
...
#define GPIO_ACTS_INIT(n, devname)						\
	...
	DEVICE_DEFINE(port_##n##_acts, devname,		\
			    gpio_acts_init, device_pm_control_nop, &port_##n##_acts_runtime,	\
			    &port_##n##_acts_config, POST_KERNEL,	\
