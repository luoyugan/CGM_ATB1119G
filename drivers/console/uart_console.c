...
static int dummy_console_out(int c)
{
	ARG_UNUSED(c);
...
void uart_console_hook_install_dummy(void)
{
	__stdout_hook_install(dummy_console_out);
	__printk_hook_install(dummy_console_out);
}
/**
 *
